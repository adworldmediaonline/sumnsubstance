...
export default function PromotionalBanner() {
  return (
    <section className="py-8 bg-gradient-to-r from-[#ffd469]/20 via-white to-[#ffd469]/20 relative overflow-hidden">
      <div className="absolute inset-0 bg-gradient-to-r from-transparent via-white/30 to-transparent"></div>
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="bg-white rounded-3xl shadow-2xl overflow-hidden border border-gray-100">
          <div className="grid lg:grid-cols-12 items-center">
            {/* Discount Badge Section */}
            <div className="lg:col-span-2 bg-gradient-to-br from-[#233f1c] via-[#2b3e1a] to-[#233f1c] text-white p-8 relative">
              ...
              <div className="absolute -top-2 -right-2 w-12 h-12 bg-[#ffd469] rounded-full animate-pulse"></div>
            </div>

            {/* Product Showcase */}
            <div className="lg:col-span-4 p-8 bg-gradient-to-br from-[#ffd469]/10 to-[#ffd469]/20">
            ...
            <div className="lg:col-span-4 p-8 text-center">
              <div className="mb-4">
                <div className="inline-block bg-gradient-to-r from-[#ffd469] to-[#233f1c] text-white px-4 py-2 rounded-full text-sm font-bold mb-4">
                  Product Of The Month
                </div>
              </div>

              <h2 className="text-3xl lg:text-4xl font-black text-[#233f1c] mb-4 leading-tight">
                Night Repair
                <span className="block text-transparent bg-clip-text bg-gradient-to-r from-[#233f1c] to-[#ffd469]">
                  Combo
                </span>
              </h2>

              <p className="text-[#233f1c]/70 mb-6 font-medium">
                Transform your skin overnight with visible results
              </p>
            </div>

            {/* CTA Section */}
            <div className="lg:col-span-2 bg-gradient-to-br from-[#233f1c] to-[#2b3e1a] text-white p-8 text-center relative">
              ...
              <div className="relative">
                ...
                <Button className="bg-[#ffd469] hover:bg-[#ffd469]/90 text-[#233f1c] font-bold px-6 py-3 rounded-full w-full shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-105">
